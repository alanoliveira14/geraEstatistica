...
Public Class ComparaJogadores2
    ...
    Public codAcao As Integer
    Public nomeAcao As String
    ...
    End Sub
    Public Function carregaComboAcao()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If cmbAcao.SelectedValue = 0 Then
            MessageBox.Show("Selecione a ação para ser comparada")
            Return
        End If
        codAcao = cmbAcao.SelectedValue
        frmgrafico.Show()
        Me.Hide()
    End Sub
End Class
